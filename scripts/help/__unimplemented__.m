...
function txt = __unimplemented__ (fcn)
  ...
  switch (fcn)
    ...
    case {"addedvarplot", "addlevels", "addTerms", "adtest", "andrewsplot", ...
          ...
          "nanmax", "nanmin", "nansum", "nbincdf", "nbinfit", "nbininv", ...
          "nbinpdf", "nbinrnd", "nbinstat", "ncfcdf", "ncfinv", "ncfpdf", ...
          "ncfrnd", "ncfstat", "nctcdf", "nctinv", "nctpdf", "nctrnd", ...
          "nctstat", "ncx2cdf", "ncx2inv", "ncx2pdf", "ncx2rnd", ...
          "ncx2stat", "negloglik", "nlinfit", "nlintool", "nlmefit", ...
          "nlmefitsa", "nlparci", "nlpredci", "nnmf", "nominal", ...
          "NonLinearModel", "normcdf", "normfit", "norminv", "normlike", ...
          "normpdf", "normplot", "normrnd", "normspec", "normstat", ...
